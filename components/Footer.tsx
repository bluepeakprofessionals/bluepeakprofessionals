        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 items-start">
          ...
          <div>
            <div className="inline-block mb-4">
              ...
              <img src="/correctlogo.png" alt="Blue Peak Pool Care" height={44} className="h-11 w-auto"  />
            </div>
          ...
          <div className="md:text-right">
            ...
            <div className="flex gap-4 mt-6 md:justify-end">
              <a
                href="https://www.facebook.com/profile.php?id=61591057470192"
                target="_blank"
              ...
              <a
                href="https://www.instagram.com/bluepeak_poolcare"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.tiktok.com/@bluepeak_poolcare"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center hover:bg-light-blue transition-colors"
